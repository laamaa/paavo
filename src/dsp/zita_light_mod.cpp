...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "zita_light_mod.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst7 = int(std::min<float>(2700.0f, std::max<float>(0.0f, (0.0599999987f * fConst0))));
		...
		iConst17 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst14 - fConst16))));
		...
		iConst27 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst24 - fConst26))));
		...
		iConst32 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst29 - fConst31))));
		...
		iConst37 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst34 - fConst36))));
		...
		iConst42 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst39 - fConst41))));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openHorizontalBox("zita_light_mod");
		...
		ui_interface->addVerticalSlider("Eq1 Level", &fVslider5, -2.0f, -15.0f, 15.0f, 0.100000001f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow25 = std::exp((fConst10 / fSlow10));
		float fSlow26 = mydsp_faustpower2_f(fSlow25);
		float fSlow27 = (1.0f - (fSlow26 * fSlow13));
		float fSlow28 = (1.0f - fSlow26);
		float fSlow29 = (fSlow27 / fSlow28);
		float fSlow30 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow27) / mydsp_faustpower2_f(fSlow28)) + -1.0f)));
		float fSlow31 = (fSlow29 - fSlow30);
		float fSlow32 = (fSlow25 * (fSlow30 + (1.0f - fSlow29)));
		float fSlow33 = ((std::exp((fConst10 / fSlow20)) / fSlow25) + -1.0f);
		float fSlow34 = std::exp((fConst15 / fSlow10));
		float fSlow35 = mydsp_faustpower2_f(fSlow34);
		float fSlow36 = (1.0f - (fSlow35 * fSlow13));
		float fSlow37 = (1.0f - fSlow35);
		float fSlow38 = (fSlow36 / fSlow37);
		float fSlow39 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow36) / mydsp_faustpower2_f(fSlow37)) + -1.0f)));
		float fSlow40 = (fSlow38 - fSlow39);
		float fSlow41 = (fSlow34 * (fSlow39 + (1.0f - fSlow38)));
		float fSlow42 = ((std::exp((fConst15 / fSlow20)) / fSlow34) + -1.0f);
		float fSlow43 = std::exp((fConst20 / fSlow10));
		float fSlow44 = mydsp_faustpower2_f(fSlow43);
		float fSlow45 = (1.0f - (fSlow44 * fSlow13));
		float fSlow46 = (1.0f - fSlow44);
		float fSlow47 = (fSlow45 / fSlow46);
		float fSlow48 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow45) / mydsp_faustpower2_f(fSlow46)) + -1.0f)));
		float fSlow49 = (fSlow47 - fSlow48);
		float fSlow50 = (fSlow43 * (fSlow48 + (1.0f - fSlow47)));
		float fSlow51 = ((std::exp((fConst20 / fSlow20)) / fSlow43) + -1.0f);
		float fSlow52 = std::exp((fConst25 / fSlow10));
		float fSlow53 = mydsp_faustpower2_f(fSlow52);
		float fSlow54 = (1.0f - (fSlow53 * fSlow13));
		float fSlow55 = (1.0f - fSlow53);
		float fSlow56 = (fSlow54 / fSlow55);
		float fSlow57 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow54) / mydsp_faustpower2_f(fSlow55)) + -1.0f)));
		float fSlow58 = (fSlow56 - fSlow57);
		float fSlow59 = (fSlow52 * (fSlow57 + (1.0f - fSlow56)));
		float fSlow60 = ((std::exp((fConst25 / fSlow20)) / fSlow52) + -1.0f);
		float fSlow61 = std::exp((fConst30 / fSlow10));
		float fSlow62 = mydsp_faustpower2_f(fSlow61);
		float fSlow63 = (1.0f - (fSlow62 * fSlow13));
		float fSlow64 = (1.0f - fSlow62);
		float fSlow65 = (fSlow63 / fSlow64);
		float fSlow66 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow63) / mydsp_faustpower2_f(fSlow64)) + -1.0f)));
		float fSlow67 = (fSlow65 - fSlow66);
		float fSlow68 = (fSlow61 * (fSlow66 + (1.0f - fSlow65)));
		float fSlow69 = ((std::exp((fConst30 / fSlow20)) / fSlow61) + -1.0f);
		float fSlow70 = std::exp((fConst35 / fSlow10));
		float fSlow71 = mydsp_faustpower2_f(fSlow70);
		float fSlow72 = (1.0f - (fSlow71 * fSlow13));
		float fSlow73 = (1.0f - fSlow71);
		float fSlow74 = (fSlow72 / fSlow73);
		float fSlow75 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow72) / mydsp_faustpower2_f(fSlow73)) + -1.0f)));
		float fSlow76 = (fSlow74 - fSlow75);
		float fSlow77 = (fSlow70 * (fSlow75 + (1.0f - fSlow74)));
		float fSlow78 = ((std::exp((fConst35 / fSlow20)) / fSlow70) + -1.0f);
		float fSlow79 = std::exp((fConst40 / fSlow10));
		float fSlow80 = mydsp_faustpower2_f(fSlow79);
		float fSlow81 = (1.0f - (fSlow80 * fSlow13));
		float fSlow82 = (1.0f - fSlow80);
		float fSlow83 = (fSlow81 / fSlow82);
		float fSlow84 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fSlow81) / mydsp_faustpower2_f(fSlow82)) + -1.0f)));
		float fSlow85 = (fSlow83 - fSlow84);
		float fSlow86 = (fSlow79 * (fSlow84 + (1.0f - fSlow83)));
		float fSlow87 = ((std::exp((fConst40 / fSlow20)) / fSlow79) + -1.0f);
		float fSlow88 = (0.0f - (std::cos((fConst1 * fSlow6)) * (fSlow9 + 1.0f)));
		float fSlow89 = (0.0f - (std::cos((fConst1 * fSlow2)) * (fSlow5 + 1.0f)));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec1[(IOTA & 16383)] = ((0.353553385f * fRec14[0]) + 9.99999968e-21f);
			float fTemp3 = float(input1[i]);
			fVec2[(IOTA & 4095)] = fTemp3;
			float fTemp4 = (0.300000012f * fVec2[((IOTA - iConst7) & 4095)]);
			float fTemp5 = (((0.600000024f * fRec12[1]) + fVec1[((IOTA - iConst6) & 16383)]) - fTemp4);
			...
			fRec18[0] = ((fSlow31 * fRec18[1]) + (fSlow32 * (fRec7[1] + (fSlow33 * fRec19[0]))));
			fVec4[(IOTA & 16383)] = ((0.353553385f * fRec18[0]) + 9.99999968e-21f);
			float fTemp6 = (((0.600000024f * fRec16[1]) + fVec4[((IOTA - iConst12) & 16383)]) - fTemp4);
			...
			fRec22[0] = ((fSlow40 * fRec22[1]) + (fSlow41 * (fRec9[1] + (fSlow42 * fRec23[0]))));
			fVec6[(IOTA & 8191)] = ((0.353553385f * fRec22[0]) + 9.99999968e-21f);
			float fTemp7 = (fVec6[((IOTA - iConst17) & 8191)] + (fTemp4 + (0.600000024f * fRec20[1])));
			...
			fRec26[0] = ((fSlow49 * fRec26[1]) + (fSlow50 * (fRec5[1] + (fSlow51 * fRec27[0]))));
			fVec8[(IOTA & 16383)] = ((0.353553385f * fRec26[0]) + 9.99999968e-21f);
			float fTemp8 = (fTemp4 + ((0.600000024f * fRec24[1]) + fVec8[((IOTA - iConst22) & 16383)]));
			...
			fRec30[0] = ((fSlow58 * fRec30[1]) + (fSlow59 * (fRec10[1] + (fSlow60 * fRec31[0]))));
			fVec10[(IOTA & 8191)] = ((0.353553385f * fRec30[0]) + 9.99999968e-21f);
			float fTemp9 = (0.300000012f * fVec0[((IOTA - iConst7) & 4095)]);
			float fTemp10 = (fVec10[((IOTA - iConst27) & 8191)] - (fTemp9 + (0.600000024f * fRec28[1])));
			...
			fRec34[0] = ((fSlow67 * fRec34[1]) + (fSlow68 * (fRec6[1] + (fSlow69 * fRec35[0]))));
			fVec12[(IOTA & 8191)] = ((0.353553385f * fRec34[0]) + 9.99999968e-21f);
			float fTemp11 = (fVec12[((IOTA - iConst32) & 8191)] - (fTemp9 + (0.600000024f * fRec32[1])));
			...
			fRec38[0] = ((fSlow76 * fRec38[1]) + (fSlow77 * (fRec8[1] + (fSlow78 * fRec39[0]))));
			fVec14[(IOTA & 8191)] = ((0.353553385f * fRec38[0]) + 9.99999968e-21f);
			float fTemp12 = ((fTemp9 + fVec14[((IOTA - iConst37) & 8191)]) - (0.600000024f * fRec36[1]));
			...
			fRec42[0] = ((fSlow85 * fRec42[1]) + (fSlow86 * (fRec4[1] + (fSlow87 * fRec43[0]))));
			fVec16[(IOTA & 8191)] = ((0.353553385f * fRec42[0]) + 9.99999968e-21f);
			float fTemp13 = ((fVec16[((IOTA - iConst42) & 8191)] + fTemp9) - (0.600000024f * fRec40[1]));
			...
			float fTemp28 = (fSlow88 * fRec45[1]);
			...
			float fTemp31 = (fSlow89 * fRec44[1]);
...
zita_light_mod::zita_light_mod() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void zita_light_mod::update(void)
{
#if MIDICTRL
...
void zita_light_mod::setParamValue(const std::string& path, float value)
{
